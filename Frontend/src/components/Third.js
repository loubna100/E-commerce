          ...
          <div class="container">
              <div class="row">
                  <div class="col-md-12">
                      ...
                      <Carousel.Item>
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <Link to="/detail/1"><img src="images\banner.jpg" alt="" width="115px" height="100px"/></Link>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <Link to="/detail/2"><img src="images\dresser.jpg" alt="" width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Link to="/detail/3"><img src="images\kitchen.jpg" alt="" width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Link to="/detail/4"><img src="images\miroir.jpg" alt="" width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Link to="/detail/5"><img src="images\pic1.png" alt=""width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Link to="/detail/6"><img src="images\pic2.png" alt="" width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                             
                              </Carousel.Item>
                              <Carousel.Item>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <Link to="/detail/7"><img src="images\banner.jpg" alt="" width="115px" height="100px"/></Link>
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <Link to="/detail/8"><img src="images\dresser.jpg" alt="" width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Link to="/detail/9"><img src="images\kitchen.jpg" alt="" width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Link to="/detail/10"><img src="images\miroir.jpg" alt="" width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Link to="/detail/11"><img src="images\pic1.png" alt=""width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <Link to="/detail/12"><img src="images\pic2.png" alt="" width="115px" height="100px"/></Link>
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
